...
public class ClassicModelsService {
    ...
    public void callAll() {
        ...
        classicModelsRepository.deleteSaleElseUpdateElseInsert();                      // EXAMPLE 15
        classicModelsRepository.deleteSalesOfEmpoyeeSalaryLt65000ElseInsert();         // EXAMPLE 16
        classicModelsRepository.updateSaleThenDeleteViaDeleteWhere();                  // EXAMPLE 17
        classicModelsRepository.updateSaleBeforeDelete();                              // EXAMPLE 18
        classicModelsRepository.deleteSaleBeforeUpdate();                              // EXAMPLE 19
    }
}