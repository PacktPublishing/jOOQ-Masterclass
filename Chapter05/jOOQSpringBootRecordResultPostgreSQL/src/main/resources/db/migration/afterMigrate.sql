...
(496,'Kelly''s Gift Shop','Snowden','Tony','+64 9 5555500',1612,'110000.00') ON CONFLICT (customer_number) DO NOTHING;;
...
insert into sale(sale_id,sale,employee_number) values 

(1, ROW(2003, 5282.64), 1370),

(2, ROW(2004, 1938.24), 1370),

(3, ROW(2004, 1676.14), 1370),

(4, ROW(2003, 3213), 1166),

(5, ROW(2004, 2121.35), 1166),

(6, ROW(2004, 3711.12), 1166),

(7, ROW(2003, 3449.26), 1611),

(8, ROW(2003, 4704.92), 1611),

(9, ROW(2004, 2974.43), 1611),

(10, ROW(2004, 4755.6), 1611),

(11, ROW(2004, 5657.4), 1611),

(12, ROW(2004, 3660.75), 1370),

(13, ROW(2004, 2812.32), 1370),

(14, ROW(2005, 1607.76), 1370),

(15, ROW(2005, 4996.62), 1370),

(16, ROW(2003, 5571.8), 1504),

(17, ROW(2003, 1491.38), 1504),

(18, ROW(2004, 3884.34), 1504),

(19, ROW(2004, 5241.44), 1504) ON CONFLICT (sale_id) DO NOTHING;
