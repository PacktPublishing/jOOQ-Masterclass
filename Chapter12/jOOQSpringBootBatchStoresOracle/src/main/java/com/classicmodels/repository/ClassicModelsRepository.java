...
public class ClassicModelsRepository {
    ...
    public void batchStoresSimple() {
        ...
        // add more new sales
        sales.add(new SaleRecord(pk(), BigInteger.valueOf(2004), 1323.23, 1370L, null, null, null, null));
        sales.add(new SaleRecord(pk(), BigInteger.valueOf(2002), 1243.25, 1504L, null, null, null, null));
        sales.add(new SaleRecord(pk(), BigInteger.valueOf(2003), 3323.26, 1504L, null, null, null, null));
