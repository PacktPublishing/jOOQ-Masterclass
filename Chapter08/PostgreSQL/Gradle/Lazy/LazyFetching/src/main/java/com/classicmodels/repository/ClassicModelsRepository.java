...
public class ClassicModelsRepository {
    ...
    public void fetchCustomerLazyOneByOne() {
        ...
        // By default, PostgreSQL JDBC retrieves the entire result set at a time. 
    ...
    public void fetchExactlyOneRow() {
        ...
        // Instruct PostgreSQL JDBC to retrieve a result set of 1 row at a time from the database cursor. 
