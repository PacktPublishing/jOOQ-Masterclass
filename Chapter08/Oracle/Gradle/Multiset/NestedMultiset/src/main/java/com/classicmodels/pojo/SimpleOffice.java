...
public class SimpleOffice implements Serializable {
    ...
    public SimpleOffice(String officeCode, String officeCity, String officeCountry, List<SimpleDepartment> departments, List<SimpleEmployee> employees, List<SimpleManager> managers) {
