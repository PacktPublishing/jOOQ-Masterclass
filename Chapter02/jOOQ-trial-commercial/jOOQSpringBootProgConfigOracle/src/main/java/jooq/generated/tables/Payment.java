...
public class Payment extends TableImpl<PaymentRecord> {
    ...
    private static final long serialVersionUID = 218348254;

    /**
     * The reference instance of <code>SYSTEM.PAYMENT</code>
     */
    ...
    /**
     * The column <code>SYSTEM.PAYMENT.CUSTOMER_NUMBER</code>.
     */
    ...
    /**
     * The column <code>SYSTEM.PAYMENT.CHECK_NUMBER</code>.
     */
    ...
    /**
     * The column <code>SYSTEM.PAYMENT.PAYMENT_DATE</code>.
     */
    public final TableField<PaymentRecord, LocalDate> PAYMENT_DATE = createField(DSL.name("PAYMENT_DATE"), org.jooq.impl.SQLDataType.LOCALDATE.nullable(false), this, "");

    /**
     * The column <code>SYSTEM.PAYMENT.INVOICE_AMOUNT</code>.
     */
    public final TableField<PaymentRecord, BigDecimal> INVOICE_AMOUNT = createField(DSL.name("INVOICE_AMOUNT"), org.jooq.impl.SQLDataType.NUMERIC(10, 2).nullable(false), this, "");

    /**
     * The column <code>SYSTEM.PAYMENT.CACHING_DATE</code>.
     */
    public final TableField<PaymentRecord, LocalDate> CACHING_DATE = createField(DSL.name("CACHING_DATE"), org.jooq.impl.SQLDataType.LOCALDATE.defaultValue(org.jooq.impl.DSL.field("NULL", org.jooq.impl.SQLDataType.LOCALDATE)), this, "");

    /**
     * Create a <code>SYSTEM.PAYMENT</code> table reference
     */
    public Payment() {
    ...
    /**
     * Create an aliased <code>SYSTEM.PAYMENT</code> table reference
     */
    ...
    public UniqueKey<PaymentRecord> getPrimaryKey() {
        return Keys.SYS_C0011306;
    }

    @Override
    public List<UniqueKey<PaymentRecord>> getKeys() {
        return Arrays.<UniqueKey<PaymentRecord>>asList(Keys.SYS_C0011306);
    }
