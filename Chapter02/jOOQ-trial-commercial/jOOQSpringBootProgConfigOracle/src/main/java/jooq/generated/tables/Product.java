...
public class Product extends TableImpl<ProductRecord> {
    ...
    private static final long serialVersionUID = -720120917;
     ...
     */
    public final TableField<ProductRecord, Long> PRODUCT_ID = createField(DSL.name("PRODUCT_ID"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
     ...
     */
    public final TableField<ProductRecord, Integer> QUANTITY_IN_STOCK = createField(DSL.name("QUANTITY_IN_STOCK"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>SYSTEM.PRODUCT.BUY_PRICE</code>.
     */
    public final TableField<ProductRecord, BigDecimal> BUY_PRICE = createField(DSL.name("BUY_PRICE"), org.jooq.impl.SQLDataType.NUMERIC(10, 2).nullable(false), this, "");

    /**
     * The column <code>SYSTEM.PRODUCT.MSRP</code>.
     */
    public final TableField<ProductRecord, BigDecimal> MSRP = createField(DSL.name("MSRP"), org.jooq.impl.SQLDataType.NUMERIC(10, 2).nullable(false), this, "");
    ...
    public UniqueKey<ProductRecord> getPrimaryKey() {
        return Keys.SYS_C0011285;
    }

    @Override
    public List<UniqueKey<ProductRecord>> getKeys() {
        return Arrays.<UniqueKey<ProductRecord>>asList(Keys.SYS_C0011285);
    }
