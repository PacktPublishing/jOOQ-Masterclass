...
flyway {
    ...
    locations = arrayOf("filesystem:./../../../../../db/migration/ddl/mssql/sql",
                        "filesystem:./../../../../../db/migration/ddl/mssql/data")
    mixed = true
}
            ...
            jooqConfiguration.apply {
                ...
                generator.apply {
                    ...
                    database.apply {
                        ...
                        Property().withKey("scripts").withValue("./../../../../../db/migration/ddl/mssql/sql"))
...
tasks.named<nu.studer.gradle.jooq.JooqGenerate>("generateJooq") {
    ...
    inputs.files(fileTree("${rootDir}/../../../../../db/migration/ddl/mssql/sql"))
