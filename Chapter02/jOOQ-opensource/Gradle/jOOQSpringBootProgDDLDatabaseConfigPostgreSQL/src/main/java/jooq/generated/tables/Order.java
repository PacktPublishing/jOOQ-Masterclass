...
public class Order extends TableImpl<OrderRecord> {
     ...
     */
    public final TableField<OrderRecord, Long> ORDER_ID = createField(DSL.name("order_id"), SQLDataType.BIGINT.nullable(false).defaultValue(DSL.field("NEXT VALUE FOR \"PUBLIC\".\"order_seq\"", SQLDataType.BIGINT)), this, "");
    ...
    public List<UniqueKey<OrderRecord>> getKeys() {
        return Arrays.<UniqueKey<OrderRecord>>asList(Keys.CONSTRAINT_6);
    }
