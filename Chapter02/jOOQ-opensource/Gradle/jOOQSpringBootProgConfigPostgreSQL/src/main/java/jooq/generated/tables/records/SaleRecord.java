...
public class SaleRecord extends UpdatableRecordImpl<SaleRecord> implements Record5<Long, Integer, Double, Long, Boolean> {
    ...
    @Override
    public Row5<Long, Integer, Double, Long, Boolean> valuesRow() {
    ...
    @Override
    public SaleRecord values(Long value1, Integer value2, Double value3, Long value4, Boolean value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SaleRecord(Long saleId, Integer fiscalYear, Double sale, Long employeeNumber, Boolean hot) {
        super(Sale.SALE);
