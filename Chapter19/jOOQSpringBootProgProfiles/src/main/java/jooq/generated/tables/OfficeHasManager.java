...
public class OfficeHasManager extends TableImpl<OfficeHasManagerRecord> {
    ...
    private static final long serialVersionUID = -10934735;
    ...
    /**
     * The column <code>public.office_has_manager.office_code</code>.
     */
    public final TableField<OfficeHasManagerRecord, String> OFFICE_CODE = createField(DSL.name("office_code"), org.jooq.impl.SQLDataType.VARCHAR(10).nullable(false), this, "");

    /**
     * The column <code>public.office_has_manager.manager_id</code>.
     */
    public final TableField<OfficeHasManagerRecord, Long> MANAGER_ID = createField(DSL.name("manager_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
    ...
    public List<ForeignKey<OfficeHasManagerRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<OfficeHasManagerRecord, ?>>asList(Keys.OFFICE_HAS_MANAGER__OFFICE_HAS_MANAGER_OFFICE_CODE_FKEY, Keys.OFFICE_HAS_MANAGER__OFFICE_HAS_MANAGER_MANAGER_ID_FKEY);
    }

    public Office office() {
        return new Office(this, Keys.OFFICE_HAS_MANAGER__OFFICE_HAS_MANAGER_OFFICE_CODE_FKEY);
    }

    public Manager manager() {
        return new Manager(this, Keys.OFFICE_HAS_MANAGER__OFFICE_HAS_MANAGER_MANAGER_ID_FKEY);
    }
