...
public class Office extends TableImpl<OfficeRecord> {
    ...
    private static final long serialVersionUID = 947751568;
    ...
    /**
     * The column <code>public.office.address_line_1</code>.
     */
    public final TableField<OfficeRecord, String> ADDRESS_LINE_1 = createField(DSL.name("address_line_1"), org.jooq.impl.SQLDataType.VARCHAR(50).nullable(false), this, "");

    /**
     * The column <code>public.office.address_line_2</code>.
     */
    public final TableField<OfficeRecord, String> ADDRESS_LINE_2 = createField(DSL.name("address_line_2"), org.jooq.impl.SQLDataType.VARCHAR(50).defaultValue(org.jooq.impl.DSL.field("NULL::character varying", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>public.office.state</code>.
     */
    public final TableField<OfficeRecord, String> STATE = createField(DSL.name("state"), org.jooq.impl.SQLDataType.VARCHAR(50).defaultValue(org.jooq.impl.DSL.field("NULL::character varying", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
    ...
    public List<UniqueKey<OfficeRecord>> getKeys() {
        return Arrays.<UniqueKey<OfficeRecord>>asList(Keys.OFFICE_PKEY);
    }
