...
public class OfficeRepository extends DAOImpl<OfficeRecord, jooq.generated.tables.pojos.Office, String> {
     ...
     */
    public List<jooq.generated.tables.pojos.Office> fetchRangeOfAddressLine_1(String lowerInclusive, String upperInclusive) {
        return fetchRange(Office.OFFICE.ADDRESS_LINE_1, lowerInclusive, upperInclusive);
    }

    /**
     * Fetch records that have <code>address_line_1 IN (values)</code>
     */
    public List<jooq.generated.tables.pojos.Office> fetchByAddressLine_1(String... values) {
        return fetch(Office.OFFICE.ADDRESS_LINE_1, values);
    }

    /**
     * Fetch records that have <code>address_line_2 BETWEEN lowerInclusive AND upperInclusive</code>
     */
    public List<jooq.generated.tables.pojos.Office> fetchRangeOfAddressLine_2(String lowerInclusive, String upperInclusive) {
        return fetchRange(Office.OFFICE.ADDRESS_LINE_2, lowerInclusive, upperInclusive);
    }

    /**
     * Fetch records that have <code>address_line_2 IN (values)</code>
     */
    public List<jooq.generated.tables.pojos.Office> fetchByAddressLine_2(String... values) {
        return fetch(Office.OFFICE.ADDRESS_LINE_2, values);
    }
