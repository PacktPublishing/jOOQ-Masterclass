...
public class ClassicModelsRepository {
    ...
    public void batchInserts() {
        ...
        int[] result11 = ctx.configuration().derive(
    ...
    public void batchMerges2() {
        ...
        BankTransactionRecord bt1 = new BankTransactionRecord(
                (int) (Math.random() * 999999), "", "", BigDecimal.ONE, LocalDateTime.now(), 112L, "BO864823", "");
        ...
        BankTransactionRecord bt2 = new BankTransactionRecord(
                (int) (Math.random() * 999999), "", "", BigDecimal.ONE, LocalDateTime.now(), 112L, "HQ55022", "");
    ...
    public void batchStoresSimple() {
        ...
        // execute an INSERT
        SaleRecord sr1 = new SaleRecord(
                (long) (Math.random() * 100001L), 2005, 1223.23, 1370L, null, null, null, null);
        ...
        int[] result = ctx.configuration().derive(
                ...
                .dsl().batch(
                        ...
                        ctx.update(EMPLOYEE)
                                .set(EMPLOYEE.SALARY, EMPLOYEE.SALARY.plus(10_000))
                                .where(EMPLOYEE.SALARY.between(55_000, 60_000)),
                        ctx.deleteFrom(BANK_TRANSACTION).where(BANK_TRANSACTION.TRANSACTION_ID.eq(1)),
                        ctx.deleteFrom(BANK_TRANSACTION).where(BANK_TRANSACTION.TRANSACTION_ID.eq(2)),
                        ctx.deleteFrom(BANK_TRANSACTION).where(BANK_TRANSACTION.TRANSACTION_ID.eq(3)),
                        ctx.deleteFrom(BANK_TRANSACTION).where(BANK_TRANSACTION.TRANSACTION_ID.eq(4))
                ).execute();
