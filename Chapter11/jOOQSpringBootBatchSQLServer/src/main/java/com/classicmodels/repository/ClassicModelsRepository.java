...
public class ClassicModelsRepository {
    ...
    public void batchInserts() {
        ...
        int[] result1 = ctx.configuration().derive(
                ...
                .dsl().batch(
                        ...
                        ctx.insertInto(SALE, SALE.FISCAL_YEAR, SALE.EMPLOYEE_NUMBER, SALE.SALE_).values(2003, 1166L, 2223.0),
                        ctx.insertInto(SALE, SALE.FISCAL_YEAR, SALE.EMPLOYEE_NUMBER, SALE.SALE_).values(2004, 1166L, 4531.35),
                        ctx.insertInto(SALE, SALE.FISCAL_YEAR, SALE.EMPLOYEE_NUMBER, SALE.SALE_).values(2004, 1166L, 6751.33)
                ).execute();
        ...
        int[] result2 = ctx.configuration().derive(
                new Settings().withBatchSize(3))
                .dsl().batch(
                        ctx.insertInto(SALE, SALE.FISCAL_YEAR, SALE.EMPLOYEE_NUMBER, SALE.SALE_).values((Integer) null, null, null))
        ...
        int[] result5 = ctx.configuration().derive(
                ...
                .dsl().batch(
                        ...
                        ctx.insertInto(SALE, SALE.SALE_ID, SALE.FISCAL_YEAR, SALE.EMPLOYEE_NUMBER, SALE.SALE_)
                                .values((long) (Math.random() * 10000000), 2005, 1370L, 1282.64),
                        ctx.insertInto(SALE, SALE.SALE_ID, SALE.FISCAL_YEAR, SALE.EMPLOYEE_NUMBER, SALE.SALE_)
                                .values((long) (Math.random() * 10000000), 2004, 1370L, 3938.24),
                        ctx.insertInto(SALE, SALE.SALE_ID, SALE.FISCAL_YEAR, SALE.EMPLOYEE_NUMBER, SALE.SALE_)
                                .values((long) (Math.random() * 10000000), 2004, 1370L, 4676.14),
        ...
        System.out.println("EXAMPLE 1.6: " + Arrays.toString(result6));
    }
    ...
    public void batchDeletes() {
        ...
        if (r1 != null && r2 != null && r3 != null) {
            ...
            System.out.println("EXAMPLE 3.3: Please, restore database to initial state and try again");
        }
    }
    ...
    public void batchStoresPreparedStatement2() {
        ...
        SaleRecord i1 = new SaleRecord((long) (Math.random() * 99999), 2005, 1223.23, 1370L, null, null, null, null);
        SaleRecord u1 = ctx.selectFrom(SALE).where(SALE.SALE_ID.eq(1L)).fetchSingle();
        u1.setFiscalYear(2006);
        SaleRecord i2 = new SaleRecord((long) (Math.random() * 99999), 2005, 9022.21, 1166L, null, null, null, null);
        SaleRecord u2 = ctx.selectFrom(SALE).where(SALE.SALE_ID.eq(2L)).fetchSingle();
        u2.setFiscalYear(2007);
        SaleRecord i3 = new SaleRecord((long) (Math.random() * 99999), 2003, 8002.22, 1504L, null, null, null, null);
        SaleRecord u3 = ctx.selectFrom(SALE).where(SALE.SALE_ID.eq(3L)).fetchSingle();
        u3.setFiscalYear(2008);
        SaleRecord i4 = new SaleRecord((long) (Math.random() * 99999), 2003, 8002.22, 1611L, null, null, null, null);
        SaleRecord u4 = ctx.selectFrom(SALE).where(SALE.SALE_ID.eq(4L)).fetchSingle();
    ...
    public void batchStoresPreparedStatement3() {
        ...
        SaleRecord i1 = new SaleRecord((long) (Math.random() * 9999999), 2005, 1223.23, 1370L, null, null, null, null);
        SaleRecord u1 = ctx.selectFrom(SALE).where(SALE.SALE_ID.eq(1L)).fetchSingle();
        u1.setFiscalYear(2016);
        SaleRecord i2 = new SaleRecord((long) (Math.random() * 9999999), 2005, 9022.21, 1166L, null, null, null, null);
        SaleRecord u2 = ctx.selectFrom(SALE).where(SALE.SALE_ID.eq(2L)).fetchSingle();
        u2.setTrend("CONSTANT");
        SaleRecord i3 = new SaleRecord((long) (Math.random() * 9999999), 2003, 8002.22, 1504L, null, null, null, null);
        SaleRecord u3 = ctx.selectFrom(SALE).where(SALE.SALE_ID.eq(3L)).fetchSingle();
        u3.setSale(0.0);
        SaleRecord i4 = new SaleRecord((long) (Math.random() * 9999999), 2003, 8002.22, 1611L, null, null, null, null);
        SaleRecord u4 = ctx.selectFrom(SALE).where(SALE.SALE_ID.eq(4L)).fetchSingle();
    ...
    public void batchStoresPreparedStatement4() {
        ...
        i1.setSaleId((long) (Math.random() * 999999999));
        ...
        i2.setSaleId((long) (Math.random() * 999999999));
        i2.setFiscalYear(2005);
        i2.setSale(9022.21);
        SaleRecord u2 = ctx.selectFrom(SALE).where(SALE.SALE_ID.eq(2L)).fetchSingle();
        u2.setTrend("DOWN");
        SaleRecord i3 = new SaleRecord();
        i3.setSaleId((long) (Math.random() * 999999999));
        ...
        i4.setSaleId((long) (Math.random() * 999999999));
    ...
    public void batchStoresStaticStatement() {
        ...
        SaleRecord i1 = new SaleRecord((long) (Math.random() * 99999999), 2005, 1223.23, 1370L, null, null, null, null);
        SaleRecord i2 = new SaleRecord((long) (Math.random() * 99999999), 2005, 9022.21, 1166L, null, null, null, null);
        SaleRecord i3 = new SaleRecord((long) (Math.random() * 99999999), 2003, 8002.22, 1504L, null, null, null, null);
        SaleRecord i4 = new SaleRecord((long) (Math.random() * 99999999), 2003, 8002.22, 1611L, null, null, null, null);
    ...
    public void batchedConnectionUsage() {
        ...
        try ( BatchedConnection conn = new BatchedConnection(DriverManager.getConnection(
            ...
            String sql1 = "insert into [sale] ([fiscal_year], [employee_number], [sale]) "
                    + "values (?, ?, ?)";
            ...
            String sql2 = "insert into [sale] ([fiscal_year], [employee_number], [sale], [trend]) "
                    + "values (?, ?, ?, ?)";
        ...
        try ( BatchedConnection conn = new BatchedConnection(DriverManager.getConnection(
            ...
            try ( PreparedStatement stmt = conn.prepareStatement("insert into [sale] ([fiscal_year], [employee_number], [sale]) "
                    + "values (?, ?, ?);")) {
            ...
            // since the following SQL string is different, next statements represents the third batch
            try ( PreparedStatement stmt = conn.prepareStatement("insert into [sale] ([fiscal_year], [employee_number], [sale], [trend]) "
                    + "values (?, ?, ?, ?);")) {
