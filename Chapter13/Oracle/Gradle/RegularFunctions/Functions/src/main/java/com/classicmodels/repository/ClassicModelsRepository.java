...
public class ClassicModelsRepository {
    ...
    public void stringFunctionsExample() {
        ...
        ctx.select(EMPLOYEE.EMAIL,
                aggregate("substr", String.class, EMPLOYEE.EMAIL, one(),
                        aggregate("instr", Integer.class, EMPLOYEE.EMAIL,
                                inline("@")).minus(1)).as("name"),
                aggregate("substr", String.class, EMPLOYEE.EMAIL,
                        aggregate("instr", Integer.class, EMPLOYEE.EMAIL,
                                inline("@")).plus(1)).as("domain"))
                .from(EMPLOYEE)
                .fetch();        
