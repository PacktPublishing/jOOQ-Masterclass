...
import jooq.generated.embeddables.pojos.SalePkEmbeddable;
import jooq.generated.embeddables.records.SalePkEmbeddableRecord;
...
public class ClassicModelsRepository {
    ...
    public void fetchSale() {
        ...
        // Record2<SalePkEmbeddableRecord, Integer>
        ...
        var result2 = ctx.select(SALE.SALE_, SALE.FISCAL_YEAR)
                .from(SALE)
                .where(SALE.SALE_PK.eq(new SalePkEmbeddableRecord(1L)))                
                .fetchSingle();
        ...
        SalePkEmbeddable result3 = ctx.select(SALE.SALE_PK)
                .from(SALE)
                .where(SALE.SALE_.gt(5000d))                
                .fetchAnyInto(SalePkEmbeddable.class);
    ...
    public void fetchToken() {
        ...
        // Record3<TokenPkEmbeddableRecord, SalePkEmbeddableRecord, Double>
