...
insert  into customer(customer_number,customer_name,contact_last_name,contact_first_name,phone,address_line_first,address_line_second,city,state,postal_code,country,sales_rep_employee_number,credit_limit) values 
...
(496,'Kelly''s Gift Shop','Snowden','Tony','+64 9 5555500','Arenales 1938 3''A''',NULL,'Auckland  ',NULL,NULL,'New Zealand',1612,'110000.00') ON CONFLICT (customer_number) DO NOTHING;;
