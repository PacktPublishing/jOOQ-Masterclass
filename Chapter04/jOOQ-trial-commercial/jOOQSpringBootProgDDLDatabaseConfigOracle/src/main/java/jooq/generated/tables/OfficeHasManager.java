...
public class OfficeHasManager extends TableImpl<OfficeHasManagerRecord> {
    ...
    public List<ForeignKey<OfficeHasManagerRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<OfficeHasManagerRecord, ?>>asList(Keys.CONSTRAINT_28, Keys.CONSTRAINT_288);
    }

    public Office office() {
        return new Office(this, Keys.CONSTRAINT_28);
    }

    public Manager manager() {
        return new Manager(this, Keys.CONSTRAINT_288);
    }
