...
public class OrderdetailRepository extends DAOImpl<OrderdetailRecord, JooqOrderdetail, Record2<Long, Long>> {
     ...
     */
    public List<JooqOrderdetail> fetchRangeOfQuantityOrdered(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<JooqOrderdetail> fetchByQuantityOrdered(Long... values) {
     ...
     */
    public List<JooqOrderdetail> fetchRangeOfOrderLineNumber(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<JooqOrderdetail> fetchByOrderLineNumber(Integer... values) {
