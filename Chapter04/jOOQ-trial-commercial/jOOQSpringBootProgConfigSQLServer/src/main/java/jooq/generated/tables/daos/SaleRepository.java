...
public class SaleRepository extends DAOImpl<SaleRecord, JooqSale, BigInteger> {
     ...
     */
    public List<JooqSale> fetchRangeOfEmployeeNumber(BigInteger lowerInclusive, BigInteger upperInclusive) {
     ...
     */
    public List<JooqSale> fetchByEmployeeNumber(BigInteger... values) {
