...
public class Orderdetail extends TableImpl<OrderdetailRecord> {
    ...
    private static final long serialVersionUID = -198169949;
     ...
     */
    public final TableField<OrderdetailRecord, Long> QUANTITY_ORDERED = createField(DSL.name("QUANTITY_ORDERED"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>SYSTEM.ORDERDETAIL.PRICE_EACH</code>.
     */
    public final TableField<OrderdetailRecord, BigDecimal> PRICE_EACH = createField(DSL.name("PRICE_EACH"), org.jooq.impl.SQLDataType.NUMERIC(10, 2).nullable(false), this, "");

    /**
     * The column <code>SYSTEM.ORDERDETAIL.ORDER_LINE_NUMBER</code>.
     */
    public final TableField<OrderdetailRecord, Integer> ORDER_LINE_NUMBER = createField(DSL.name("ORDER_LINE_NUMBER"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
    ...
    public UniqueKey<OrderdetailRecord> getPrimaryKey() {
        return Keys.SYS_C0011299;
    }

    @Override
    public List<UniqueKey<OrderdetailRecord>> getKeys() {
        return Arrays.<UniqueKey<OrderdetailRecord>>asList(Keys.SYS_C0011299);
    }
