...
public class Productline extends TableImpl<ProductlineRecord> {
     ...
     */
    public final TableField<ProductlineRecord, LocalDate> CREATED_ON = createField(DSL.name("created_on"), SQLDataType.LOCALDATE.nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", SQLDataType.LOCALDATE)), this, "");
