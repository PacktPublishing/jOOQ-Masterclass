...
public class Payment extends TableImpl<PaymentRecord> {
    ...
    private static final long serialVersionUID = 1734854545;
     ...
     */
    public final TableField<PaymentRecord, LocalDate> CACHING_DATE = createField(DSL.name("caching_date"), org.jooq.impl.SQLDataType.LOCALDATE, this, "");
    ...
    public List<ForeignKey<PaymentRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<PaymentRecord, ?>>asList(Keys.PAYMENT__PAYMENTS_IBFK_1);
    }

    public Customer customer() {
        return new Customer(this, Keys.PAYMENT__PAYMENTS_IBFK_1);
    }
