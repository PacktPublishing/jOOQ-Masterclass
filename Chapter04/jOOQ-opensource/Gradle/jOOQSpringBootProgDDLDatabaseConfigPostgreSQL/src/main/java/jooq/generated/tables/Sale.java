...
public class Sale extends TableImpl<SaleRecord> {
     ...
     */
    public final TableField<SaleRecord, Long> SALE_ID = createField(DSL.name("sale_id"), SQLDataType.BIGINT.nullable(false).defaultValue(DSL.field("NEXT VALUE FOR \"PUBLIC\".\"sale_seq\"", SQLDataType.BIGINT)), this, "");
