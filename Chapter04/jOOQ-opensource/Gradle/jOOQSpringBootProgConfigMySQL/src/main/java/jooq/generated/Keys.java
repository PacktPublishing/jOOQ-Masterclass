...
public class Keys {
    ...
    public static final UniqueKey<ProductlineRecord> KEY_PRODUCTLINE_PRIMARY = Internal.createUniqueKey(Productline.PRODUCTLINE, DSL.name("KEY_productline_PRIMARY"), new TableField[] { Productline.PRODUCTLINE.PRODUCT_LINE }, true);
