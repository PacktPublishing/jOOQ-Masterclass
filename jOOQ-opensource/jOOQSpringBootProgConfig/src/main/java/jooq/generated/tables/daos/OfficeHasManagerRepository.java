...
public class OfficeHasManagerRepository extends DAOImpl<OfficeHasManagerRecord, jooq.generated.tables.pojos.OfficeHasManager, Record2<String, Long>> {
     ...
     */
    public List<jooq.generated.tables.pojos.OfficeHasManager> fetchRangeOfOfficesOfficeCode(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<jooq.generated.tables.pojos.OfficeHasManager> fetchByOfficesOfficeCode(String... values) {
     ...
     */
    public List<jooq.generated.tables.pojos.OfficeHasManager> fetchRangeOfManagersManagerId(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<jooq.generated.tables.pojos.OfficeHasManager> fetchByManagersManagerId(Long... values) {
