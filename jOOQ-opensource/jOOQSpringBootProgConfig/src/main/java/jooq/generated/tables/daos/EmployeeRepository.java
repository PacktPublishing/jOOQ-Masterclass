...
public class EmployeeRepository extends DAOImpl<EmployeeRecord, jooq.generated.tables.pojos.Employee, Long> {
     ...
     */
    public List<jooq.generated.tables.pojos.Employee> fetchRangeOfSalary(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<jooq.generated.tables.pojos.Employee> fetchBySalary(Integer... values) {
