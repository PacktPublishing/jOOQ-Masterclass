...
public class Customer extends TableImpl<CustomerRecord> {
    ...
    private static final long serialVersionUID = -1288916800;
    ...
    /**
     * The column <code>public.customer.address_line_1</code>.
     */
    public final TableField<CustomerRecord, String> ADDRESS_LINE_1 = createField(DSL.name("address_line_1"), org.jooq.impl.SQLDataType.VARCHAR(50).nullable(false), this, "");

    /**
     * The column <code>public.customer.address_line_2</code>.
     */
    public final TableField<CustomerRecord, String> ADDRESS_LINE_2 = createField(DSL.name("address_line_2"), org.jooq.impl.SQLDataType.VARCHAR(50).defaultValue(org.jooq.impl.DSL.field("NULL::character varying", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>public.customer.city</code>.
     */
    public final TableField<CustomerRecord, String> CITY = createField(DSL.name("city"), org.jooq.impl.SQLDataType.VARCHAR(50).nullable(false), this, "");

    /**
     * The column <code>public.customer.state</code>.
     */
    public final TableField<CustomerRecord, String> STATE = createField(DSL.name("state"), org.jooq.impl.SQLDataType.VARCHAR(50).defaultValue(org.jooq.impl.DSL.field("NULL::character varying", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>public.customer.postal_code</code>.
     */
    public final TableField<CustomerRecord, String> POSTAL_CODE = createField(DSL.name("postal_code"), org.jooq.impl.SQLDataType.VARCHAR(15).defaultValue(org.jooq.impl.DSL.field("NULL::character varying", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>public.customer.country</code>.
     */
    public final TableField<CustomerRecord, String> COUNTRY = createField(DSL.name("country"), org.jooq.impl.SQLDataType.VARCHAR(50).nullable(false), this, "");
