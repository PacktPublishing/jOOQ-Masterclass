...
import com.classicmodels.properties.FlywayProperties;
...
public class JooqConfig {
    ...
    public Flyway primaryFlyway(@Qualifier("flywayProperties") FlywayProperties flywayProperties) {
