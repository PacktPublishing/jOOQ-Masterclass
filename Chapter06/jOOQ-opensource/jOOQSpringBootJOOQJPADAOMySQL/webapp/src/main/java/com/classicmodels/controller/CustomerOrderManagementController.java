...
public class CustomerOrderManagementController {
    ...
    public List<Customer> fetchSalesReps(@RequestParam Long nr) {
        
        return customerOrderManagementService.fetchSalesReps(nr);
    }
    ...
    @GetMapping("/ordersInRange")
    public List<Order> fetchOrdersInRange(@RequestParam Long min, @RequestParam Long max) {
        
        return customerOrderManagementService.fetchOrdersInRange(min, max);
    }
}
