...
public class CustomerOrderManagementService {
    ...
    public List<Customer> fetchSalesReps(Long nr) {
        
        return customerRepository.fetchBySalesRepEmployeeNumber(nr);
    }
    ...
    public List<Order> fetchOrdersInRange(Long min, Long max) {

        return orderRepository.fetchRangeOfOrderId(min, max);
    }
}
