...
public class ClassicModelsRepository {
    ...
    public void batchPlainSql() {
        ...
        int[] resultPlain1 = ctx.queries(
                query("insert into [classicmodels].[dbo].[sale] ([fiscal_year], [employee_number], [sale], [fiscal_month], [revenue_growth]) values (2005, 1370, 1.28264E3, 1, 0E0)"), 
                query("insert into [classicmodels].[dbo].[sale] ([fiscal_year], [employee_number], [sale], [fiscal_month], [revenue_growth]) values (2004, 1370, 3.93824E3, 1, 0E0)"), 
                query("insert into [classicmodels].[dbo].[sale] ([fiscal_year], [employee_number], [sale], [fiscal_month], [revenue_growth]) values (2004, 1370, 4.67614E3, 1, 0E0)")
        ).executeBatch();
