...
public class ClassicModelsRepository {
    ...
    public void batchInsertRecords2() {
        ...
        BankTransactionRecord bt1 = new BankTransactionRecord(
                null, "", "", BigDecimal.ZERO, LocalDateTime.now(), 114L, "NP603840", "VisaElectron", "");
    ...
    public void batchInsertCollectionOfObjects() {
        ...
        sales.forEach(s -> batch.bind(s.getFiscalYear(), s.getEmployeeNumber(), s.getSale(), s.getFiscalMonth(), s.getRevenueGrowth()));
        batch.execute();
    }

    public void forceNumberOfBatches() {

        // by default the generated INSERT has 5 placeholders
        ...
        // by default the generated INSERT has 6 placeholders
        ...
        // insert into `classicmodels`.`sale` (`sale_id`, `fiscal_year`, `sale`, `employee_number`, `hot`, `rate`, `vat`, `fiscal_month`, `revenue_growth`, `trend`) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
