...
public class ClassicModelsRepository {
    ...
    public void batchedConnectionUsage() {
        ...
        try ( BatchedConnection conn = new BatchedConnection(DriverManager.getConnection(
                "jdbc:oracle:thin:@localhost:1521:xe", "CLASSICMODELS", "root"), 2)) {

            String sql1 = "insert into \"CLASSICMODELS\".\"SALE\" (\"CLASSICMODELS\".\"SALE\".\"FISCAL_YEAR\", \"CLASSICMODELS\".\"SALE\".\"EMPLOYEE_NUMBER\", \"CLASSICMODELS\".\"SALE\".\"SALE\", \"CLASSICMODELS\".\"SALE\".\"FISCAL_MONTH\", \"CLASSICMODELS\".\"SALE\".\"REVENUE_GROWTH\") "
                    + "values (?, ?, ?, ?, ?)";
            ...
            String sql2 = "insert into \"CLASSICMODELS\".\"SALE\" (\"CLASSICMODELS\".\"SALE\".\"FISCAL_YEAR\", \"CLASSICMODELS\".\"SALE\".\"EMPLOYEE_NUMBER\", \"CLASSICMODELS\".\"SALE\".\"SALE\", \"CLASSICMODELS\".\"SALE\".\"FISCAL_MONTH\", \"CLASSICMODELS\".\"SALE\".\"REVENUE_GROWTH\", \"CLASSICMODELS\".\"SALE\".\"TREND\") "
                    + "values (?, ?, ?, ?, ?, ?)";
        ...
        try ( BatchedConnection conn = new BatchedConnection(DriverManager.getConnection(
            ...
            try ( PreparedStatement stmt = conn.prepareStatement("insert into \"CLASSICMODELS\".\"SALE\" (\"CLASSICMODELS\".\"SALE\".\"FISCAL_YEAR\", \"CLASSICMODELS\".\"SALE\".\"EMPLOYEE_NUMBER\", \"CLASSICMODELS\".\"SALE\".\"SALE\", \"CLASSICMODELS\".\"SALE\".\"FISCAL_MONTH\", \"CLASSICMODELS\".\"SALE\".\"REVENUE_GROWTH\") "
                    + "values (?, ?, ?, ?, ?)")) {
            ...
            // since the following SQL string is different, next statements represents the third batch
            try ( PreparedStatement stmt = conn.prepareStatement("insert into \"CLASSICMODELS\".\"SALE\" (\"CLASSICMODELS\".\"SALE\".\"FISCAL_YEAR\", \"CLASSICMODELS\".\"SALE\".\"EMPLOYEE_NUMBER\", \"CLASSICMODELS\".\"SALE\".\"SALE\", \"CLASSICMODELS\".\"SALE\".\"FISCAL_MONTH\", \"CLASSICMODELS\".\"SALE\".\"REVENUE_GROWTH\", \"CLASSICMODELS\".\"SALE\".\"TREND\") "
                    + "values (?, ?, ?, ?, ?, ?)")) {
    ...
    public void batchingOneToMany() {
        ...
        ctx.batched((Configuration c) -> {
            long c1 = c.dsl().insertInto(CUSTOMER, CUSTOMER.CUSTOMER_NAME, CUSTOMER.CONTACT_FIRST_NAME,
                    ...
                    .values("customer_1","ccn1","ccl1","p1")                    
            ...
            long c2 = c.dsl().insertInto(CUSTOMER, CUSTOMER.CUSTOMER_NAME, CUSTOMER.CONTACT_FIRST_NAME,
                    CUSTOMER.CONTACT_LAST_NAME, CUSTOMER.PHONE)
                    .values("customer_2","ccn2","ccl2","p2")                    
                    .returningResult(CUSTOMER.CUSTOMER_NUMBER).fetchOneInto(Long.class);
