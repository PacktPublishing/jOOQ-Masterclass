...
public class SaleRepository extends DAOImpl<SaleRecord, JooqSale, Long> {
     ...
     */
    public List<JooqSale> fetchRangeOfRate(StarType lowerInclusive, StarType upperInclusive) {
     ...
     */
    public List<JooqSale> fetchByRate(StarType... values) {
     ...
     */
    public List<JooqSale> fetchRangeOfVat(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<JooqSale> fetchByVat(Integer... values) {
     ...
     */
    public List<JooqSale> fetchRangeOfTrend(TrendType lowerInclusive, TrendType upperInclusive) {
     ...
     */
    public List<JooqSale> fetchByTrend(TrendType... values) {
