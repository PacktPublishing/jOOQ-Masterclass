...
public class BankTransaction extends TableImpl<BankTransactionRecord> {
     ...
     */
    public final TableField<BankTransactionRecord, BigDecimal> TRANSFER_AMOUNT = createField(DSL.name("transfer_amount"), SQLDataType.DECIMAL(10, 2).nullable(false), this, "");

    /**
     * The column <code>classicmodels.bank_transaction.caching_date</code>.
     */
    public final TableField<BankTransactionRecord, LocalDateTime> CACHING_DATE = createField(DSL.name("caching_date"), SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", SQLDataType.LOCALDATETIME)), this, "");
