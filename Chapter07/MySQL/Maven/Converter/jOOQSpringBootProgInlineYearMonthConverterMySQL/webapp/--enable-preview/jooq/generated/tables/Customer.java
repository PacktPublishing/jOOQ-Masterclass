...
public class Customer extends TableImpl<CustomerRecord> {
     ...
     */
    public final TableField<CustomerRecord, BigDecimal> CREDIT_LIMIT = createField(DSL.name("credit_limit"), SQLDataType.DECIMAL(10, 2), this, "");

    /**
     * The column <code>classicmodels.customer.first_buy_date</code>.
     */
    public final TableField<CustomerRecord, YearMonth> FIRST_BUY_DATE = createField(DSL.name("first_buy_date"), SQLDataType.INTEGER, this, "", Converter.ofNullable(Integer.class, YearMonth.class, (Integer t) -> { return YearMonth.of(1970, 1).with(java.time.temporal.ChronoField.PROLEPTIC_MONTH, t); }, (YearMonth u) -> { return (int) u.getLong(java.time.temporal.ChronoField.PROLEPTIC_MONTH); }));
