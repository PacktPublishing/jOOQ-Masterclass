...
insert  into office(office_code,location,phone,address_line_first,address_line_second,postal_code,territory) values 

('1',ROW('San Francisco','CA','USA'),'+1 650 219 4782','100 Market Street','Suite 300','94080','NA'),

('2',ROW('Boston','MA','USA'),'+1 215 837 0825','1550 Court Place','Suite 102','02107','NA'),

('3',ROW('NYC','NY','USA'),'+1 212 555 3000','523 East 53rd Street','apt. 5A','10022','NA'),

('4',ROW('Paris',NULL,'France'),'+33 14 723 4404','43 Rue Jouffroy D''abbans',NULL,'75017','EMEA'),

('5',ROW('Tokyo','Chiyoda-Ku','Japan'),'+81 33 224 5000','4-1 Kioicho',NULL,'102-8578','Japan'),

('6',ROW('Sydney',NULL,'Australia'),'+61 2 9264 2451','5-11 Wentworth Avenue','Floor --2','NSW 2010','APAC'),

('7',ROW('London',NULL,'UK'),'+44 20 7877 2041','25 Old Broad Street','Level 7','EC2N 1HN','EMEA'),

('8',ROW(NULL,NULL,'USA'),'+44 20 1827 21411','25 Hum Street','Level 2','EC2N 1HN','EMEA'), 

('9',ROW('Bucharest',NULL,NULL),'+44 20 1827 21411','22 DN1','Level 12','EC2N 1HN','NA'), 

('10',ROW(NULL,NULL,NULL),'+44 20 1827 21411','12 Home','Level 22','EC2N 1HN','NA'), 

('11',ROW('Paris',NULL,'France'),'+32 12 713 4304','43 Rue 2',NULL,'25017','EMEA'),
