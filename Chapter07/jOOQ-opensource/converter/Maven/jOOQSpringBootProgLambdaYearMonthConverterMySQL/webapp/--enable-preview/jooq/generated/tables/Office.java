...
public class Office extends TableImpl<OfficeRecord> {
     ...
     */
    public final TableField<OfficeRecord, String> ADDRESS_LINE_SECOND = createField(DSL.name("address_line_second"), SQLDataType.VARCHAR(50), this, "");

    /**
     * The column <code>classicmodels.office.state</code>.
     */
    public final TableField<OfficeRecord, String> STATE = createField(DSL.name("state"), SQLDataType.VARCHAR(50), this, "");
    ...
    public final TableField<OfficeRecord, Object> LOCATION = createField(DSL.name("location"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"classicmodels\".\"office_location\""), this, "");
