...
public class Manager extends TableImpl<ManagerRecord> {
    ...
    /**
     * The column <code>classicmodels.manager.manager_evaluation</code>.
     */
    public final TableField<ManagerRecord, String> MANAGER_EVALUATION = createField(DSL.name("manager_evaluation"), SQLDataType.VARCHAR(200), this, "");
