...
public class Employee extends TableImpl<EmployeeRecord> {
    ...
    /**
     * The reference instance of <code>classicmodels.dbo.employee</code>
     */
    ...
    /**
     * The column <code>classicmodels.dbo.employee.employee_number</code>.
     */
    ...
    /**
     * The column <code>classicmodels.dbo.employee.last_name</code>.
     */
    ...
    /**
     * The column <code>classicmodels.dbo.employee.first_name</code>.
     */
    ...
    /**
     * The column <code>classicmodels.dbo.employee.extension</code>.
     */
    ...
    /**
     * The column <code>classicmodels.dbo.employee.email</code>.
     */
    ...
    /**
     * The column <code>classicmodels.dbo.employee.office_code</code>.
     */
    ...
    /**
     * The column <code>classicmodels.dbo.employee.salary</code>.
     */
    ...
    /**
     * The column <code>classicmodels.dbo.employee.reports_to</code>.
     */
    ...
    /**
     * The column <code>classicmodels.dbo.employee.job_title</code>.
     */
    ...
    /**
     * The column <code>classicmodels.dbo.employee.employee_of_year</code>.
     */
    public final TableField<EmployeeRecord, String> EMPLOYEE_OF_YEAR = createField(DSL.name("employee_of_year"), SQLDataType.VARCHAR(50).defaultValue(DSL.field("(NULL)", SQLDataType.VARCHAR)), this, "");
    ...
    /**
     * Create an aliased <code>classicmodels.dbo.employee</code> table reference
     */
    ...
    /**
     * Create a <code>classicmodels.dbo.employee</code> table reference
     */
    public Employee() {
    ...
    public UniqueKey<EmployeeRecord> getPrimaryKey() {
        return Keys.EMPLOYEE__PK__EMPLOYEE__8C453B0C30D6925D;
    }

    @Override
    public List<UniqueKey<EmployeeRecord>> getKeys() {
        return Arrays.<UniqueKey<EmployeeRecord>>asList(Keys.EMPLOYEE__PK__EMPLOYEE__8C453B0C30D6925D);
    }
