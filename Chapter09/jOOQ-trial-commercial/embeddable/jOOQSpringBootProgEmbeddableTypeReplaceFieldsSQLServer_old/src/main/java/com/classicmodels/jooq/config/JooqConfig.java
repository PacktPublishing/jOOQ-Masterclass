                        ...
                        .withDatabase(new Database()
                                .withEmbeddables(
                                        new EmbeddableDefinitionType()
                                                .withCatalog(jooqProperties.getWithCatalog())
                                                .withSchema(jooqProperties.getWithSchema())
                                                .withName(jooqProperties.getWithEmbeddableName())
                                                .withComment(jooqProperties.getWithComment())
                                                .withTables(jooqProperties.getWithTables())
                                                .withFields(
                                                        new EmbeddableField()
                                                                .withExpression("CITY"),
                                                        new EmbeddableField()
