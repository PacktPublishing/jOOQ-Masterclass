...
public class SaleRecord extends UpdatableRecordImpl<SaleRecord> implements Record8<Long, Integer, Double, Long, Boolean, String, String, String> {
    ...
    @Override
    public Row8<Long, Integer, Double, Long, Boolean, String, String, String> valuesRow() {
    ...
    @Override
    public SaleRecord value6(String value) {
        setRate(value);
        return this;
    }

    @Override
    public SaleRecord value7(String value) {
        setVat(value);
        return this;
    }
    ...
    @Override
    public SaleRecord values(Long value1, Integer value2, Double value3, Long value4, Boolean value5, String value6, String value7, String value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SaleRecord(Long saleId, Integer fiscalYear, Double sale, Long employeeNumber, Boolean hot, String rate, String vat, String trend) {
        super(Sale.SALE);
