...
public class DepartmentRepository extends DAOImpl<DepartmentRecord, JooqDepartment, Long> {
     ...
     */
    public List<JooqDepartment> fetchRangeOfTopic(TopicarrRecord lowerInclusive, TopicarrRecord upperInclusive) {
     ...
     */
    public List<JooqDepartment> fetchByTopic(TopicarrRecord... values) {
