...
public class Top3product extends TableImpl<Top3productRecord> {
    ...
    /**
     * The reference instance of <code>SYSTEM.TOP3PRODUCT</code>
     */
    ...
    /**
     * The column <code>SYSTEM.TOP3PRODUCT.PRODUCT_ID</code>.
     */
    ...
    /**
     * The column <code>SYSTEM.TOP3PRODUCT.PRODUCT_NAME</code>.
     */
    ...
    /**
     * Create an aliased <code>SYSTEM.TOP3PRODUCT</code> table reference
     */
    ...
    /**
     * Create a <code>SYSTEM.TOP3PRODUCT</code> table reference
     */
    public Top3product() {
    ...
    public UniqueKey<Top3productRecord> getPrimaryKey() {
        return Keys.SYS_C0013897;
    }

    @Override
    public List<UniqueKey<Top3productRecord>> getKeys() {
        return Arrays.<UniqueKey<Top3productRecord>>asList(Keys.SYS_C0013897);
    }
