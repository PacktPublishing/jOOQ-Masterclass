...
public class ManagerRepository extends DAOImpl<ManagerRecord, JooqManager, Long> {
     ...
     */
    public List<JooqManager> fetchRangeOfManagerDetail(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<JooqManager> fetchByManagerDetail(String... values) {
