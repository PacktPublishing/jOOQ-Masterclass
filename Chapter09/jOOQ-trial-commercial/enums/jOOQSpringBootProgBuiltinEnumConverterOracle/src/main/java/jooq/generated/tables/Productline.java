...
public class Productline extends TableImpl<ProductlineRecord> {
    ...
    /**
     * The column <code>SYSTEM.PRODUCTLINE.CODE</code>.
     */
    ...
    /**
     * The column <code>SYSTEM.PRODUCTLINE.CREATED_ON</code>.
     */
    public final TableField<ProductlineRecord, LocalDate> CREATED_ON = createField(DSL.name("CREATED_ON"), SQLDataType.LOCALDATE.nullable(false).defaultValue(DSL.field("SYSDATE ", SQLDataType.LOCALDATE)), this, "");
    ...
    public UniqueKey<ProductlineRecord> getPrimaryKey() {
        return Keys.SYS_C0013869;
    }

    @Override
    public List<UniqueKey<ProductlineRecord>> getKeys() {
        return Arrays.<UniqueKey<ProductlineRecord>>asList(Keys.SYS_C0013869, Keys.UNIQUE_PRODUCT_LINE);
    }
