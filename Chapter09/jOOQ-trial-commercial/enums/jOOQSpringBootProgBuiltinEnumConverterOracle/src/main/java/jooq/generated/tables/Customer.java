...
public class Customer extends TableImpl<CustomerRecord> {
    ...
    /**
     * The column <code>SYSTEM.CUSTOMER.FIRST_BUY_DATE</code>.
     */
    public final TableField<CustomerRecord, BigInteger> FIRST_BUY_DATE = createField(DSL.name("FIRST_BUY_DATE"), SQLDataType.DECIMAL_INTEGER(38).defaultValue(DSL.field("NULL", SQLDataType.DECIMAL_INTEGER)), this, "");
    ...
    public UniqueKey<CustomerRecord> getPrimaryKey() {
        return Keys.SYS_C0013846;
    }

    @Override
    public List<UniqueKey<CustomerRecord>> getKeys() {
        return Arrays.<UniqueKey<CustomerRecord>>asList(Keys.SYS_C0013846);
    }
    ...
    @Override
    public Row8<Long, String, String, String, String, Long, BigDecimal, BigInteger> fieldsRow() {
