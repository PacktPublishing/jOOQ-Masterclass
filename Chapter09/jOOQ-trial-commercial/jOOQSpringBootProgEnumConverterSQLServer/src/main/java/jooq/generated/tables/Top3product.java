...
public class Top3product extends TableImpl<Top3productRecord> {
    ...
    /**
     * The reference instance of <code>classicmodels.dbo.top3product</code>
     */
    ...
    /**
     * The column <code>classicmodels.dbo.top3product.product_id</code>.
     */
    public final TableField<Top3productRecord, Long> PRODUCT_ID = createField(DSL.name("product_id"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>classicmodels.dbo.top3product.product_name</code>.
     */
    public final TableField<Top3productRecord, String> PRODUCT_NAME = createField(DSL.name("product_name"), SQLDataType.VARCHAR(70).defaultValue(DSL.field("(NULL)", SQLDataType.VARCHAR)), this, "");
    ...
    /**
     * Create an aliased <code>classicmodels.dbo.top3product</code> table reference
     */
    ...
    /**
     * Create a <code>classicmodels.dbo.top3product</code> table reference
     */
    public Top3product() {
    ...
    public UniqueKey<Top3productRecord> getPrimaryKey() {
        return Keys.TOP3PRODUCT__PK__TOP3PROD__47027DF5E71E3CF8;
    }

    @Override
    public List<UniqueKey<Top3productRecord>> getKeys() {
        return Arrays.<UniqueKey<Top3productRecord>>asList(Keys.TOP3PRODUCT__PK__TOP3PROD__47027DF5E71E3CF8);
    }
