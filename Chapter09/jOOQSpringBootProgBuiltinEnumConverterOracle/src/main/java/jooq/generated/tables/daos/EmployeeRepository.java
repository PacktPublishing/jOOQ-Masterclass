...
public class EmployeeRepository extends DAOImpl<EmployeeRecord, JooqEmployee, Long> {
     ...
     */
    public List<JooqEmployee> fetchRangeOfEmployeeOfYear(EmployeeofyeararrRecord lowerInclusive, EmployeeofyeararrRecord upperInclusive) {
     ...
     */
    public List<JooqEmployee> fetchByEmployeeOfYear(EmployeeofyeararrRecord... values) {
