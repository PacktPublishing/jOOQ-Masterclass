...
public class Payment extends TableImpl<PaymentRecord> {
     ...
     */
    public final TableField<PaymentRecord, LocalDateTime> CACHING_DATE = createField(DSL.name("CACHING_DATE"), SQLDataType.LOCALDATETIME(6).defaultValue(DSL.field("NULL", SQLDataType.LOCALDATETIME)), this, "");
    ...
    public UniqueKey<PaymentRecord> getPrimaryKey() {
        return Keys.SYS_C0013903;
    }

    @Override
    public List<UniqueKey<PaymentRecord>> getKeys() {
        return Arrays.<UniqueKey<PaymentRecord>>asList(Keys.SYS_C0013903, Keys.UNIQUE_CHECK_NUMBER);
    }
