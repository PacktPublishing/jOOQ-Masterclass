...
public class CustomerRepository extends DAOImpl<CustomerRecord, JooqCustomer, Long> {
     ...
     */
    public List<JooqCustomer> fetchRangeOfFirstBuyDate(BigInteger lowerInclusive, BigInteger upperInclusive) {
     ...
     */
    public List<JooqCustomer> fetchByFirstBuyDate(BigInteger... values) {
