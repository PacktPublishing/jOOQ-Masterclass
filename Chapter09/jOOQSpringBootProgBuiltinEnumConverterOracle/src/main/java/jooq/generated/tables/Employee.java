...
public class Employee extends TableImpl<EmployeeRecord> {
     ...
     */
    public final TableField<EmployeeRecord, BigInteger> SALARY = createField(DSL.name("SALARY"), SQLDataType.DECIMAL_INTEGER(38).nullable(false), this, "");
    ...
    /**
     * The column <code>SYSTEM.EMPLOYEE.EMPLOYEE_OF_YEAR</code>.
     */
    public final TableField<EmployeeRecord, EmployeeofyeararrRecord> EMPLOYEE_OF_YEAR = createField(DSL.name("EMPLOYEE_OF_YEAR"), SQLDataType.NUMERIC.asArrayDataType(jooq.generated.udt.records.EmployeeofyeararrRecord.class), this, "");
    ...
    public UniqueKey<EmployeeRecord> getPrimaryKey() {
        return Keys.SYS_C0013831;
    }

    @Override
    public List<UniqueKey<EmployeeRecord>> getKeys() {
        return Arrays.<UniqueKey<EmployeeRecord>>asList(Keys.SYS_C0013831);
    }
