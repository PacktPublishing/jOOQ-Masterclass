...
public class Department extends TableImpl<DepartmentRecord> {
    ...
    private static final long serialVersionUID = -1214548416;
     ...
     */
    public final TableField<DepartmentRecord, Long> DEPARTMENT_ID = createField(DSL.name("department_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<DepartmentRecord, Short> CODE = createField(DSL.name("code"), org.jooq.impl.SQLDataType.SMALLINT.defaultValue(org.jooq.impl.DSL.inline("1", org.jooq.impl.SQLDataType.SMALLINT)), this, "");
     ...
     */
    public final TableField<DepartmentRecord, String> TOPIC = createField(DSL.name("topic"), org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>classicmodels.department.dep_net_ipv4</code>.
     */
    public final TableField<DepartmentRecord, String> DEP_NET_IPV4 = createField(DSL.name("dep_net_ipv4"), org.jooq.impl.SQLDataType.VARCHAR(16), this, "");
