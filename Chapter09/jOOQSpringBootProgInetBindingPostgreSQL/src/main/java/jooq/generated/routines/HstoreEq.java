...
public class HstoreEq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -403393979;

    /**
     * The parameter <code>public.hstore_eq.RETURN_VALUE</code>.
     */
     ...
     */
    public HstoreEq() {
        super("hstore_eq", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
