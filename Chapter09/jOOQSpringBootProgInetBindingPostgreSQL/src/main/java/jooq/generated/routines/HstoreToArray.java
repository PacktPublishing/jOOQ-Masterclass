...
public class HstoreToArray extends AbstractRoutine<String[]> {

    private static final long serialVersionUID = 298425093;

    /**
     * The parameter <code>public.hstore_to_array.RETURN_VALUE</code>.
     */
     ...
     */
    public HstoreToArray() {
        super("hstore_to_array", Public.PUBLIC, org.jooq.impl.SQLDataType.CLOB.getArrayDataType());
