...
public class HsContained extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1733010705;

    /**
     * The parameter <code>public.hs_contained.RETURN_VALUE</code>.
     */
     ...
     */
    public HsContained() {
        super("hs_contained", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
