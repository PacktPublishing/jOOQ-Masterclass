...
public class ExistsAny extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -389059362;

    /**
     * The parameter <code>public.exists_any.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.exists_any._2</code>.
     */
     ...
     */
    public ExistsAny() {
        super("exists_any", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
