...
public class HstoreGe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1534213087;

    /**
     * The parameter <code>public.hstore_ge.RETURN_VALUE</code>.
     */
     ...
     */
    public HstoreGe() {
        super("hstore_ge", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
