...
public class HstoreHash extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -831102897;

    /**
     * The parameter <code>public.hstore_hash.RETURN_VALUE</code>.
     */
     ...
     */
    public HstoreHash() {
        super("hstore_hash", Public.PUBLIC, org.jooq.impl.SQLDataType.INTEGER);
