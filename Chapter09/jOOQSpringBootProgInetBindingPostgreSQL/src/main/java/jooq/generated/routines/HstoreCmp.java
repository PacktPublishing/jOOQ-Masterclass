...
public class HstoreCmp extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1078329627;

    /**
     * The parameter <code>public.hstore_cmp.RETURN_VALUE</code>.
     */
     ...
     */
    public HstoreCmp() {
        super("hstore_cmp", Public.PUBLIC, org.jooq.impl.SQLDataType.INTEGER);
