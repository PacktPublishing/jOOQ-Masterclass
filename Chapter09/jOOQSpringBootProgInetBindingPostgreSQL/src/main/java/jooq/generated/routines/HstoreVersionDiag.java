...
public class HstoreVersionDiag extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -1155468401;

    /**
     * The parameter <code>public.hstore_version_diag.RETURN_VALUE</code>.
     */
     ...
     */
    public HstoreVersionDiag() {
        super("hstore_version_diag", Public.PUBLIC, org.jooq.impl.SQLDataType.INTEGER);
