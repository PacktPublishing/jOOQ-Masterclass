...
public class Fetchval extends AbstractRoutine<String> {

    private static final long serialVersionUID = 1455064214;

    /**
     * The parameter <code>public.fetchval.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>public.fetchval._2</code>.
     */
     ...
     */
    public Fetchval() {
        super("fetchval", Public.PUBLIC, org.jooq.impl.SQLDataType.CLOB);
