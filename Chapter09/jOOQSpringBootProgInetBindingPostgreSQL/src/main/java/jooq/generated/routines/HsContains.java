...
public class HsContains extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -866598173;

    /**
     * The parameter <code>public.hs_contains.RETURN_VALUE</code>.
     */
     ...
     */
    public HsContains() {
        super("hs_contains", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
