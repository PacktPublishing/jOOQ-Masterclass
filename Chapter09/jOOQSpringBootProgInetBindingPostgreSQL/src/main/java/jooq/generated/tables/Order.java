...
public class Order extends TableImpl<OrderRecord> {
    ...
    private static final long serialVersionUID = 1728054914;
     ...
     */
    public final TableField<OrderRecord, Long> ORDER_ID = createField(DSL.name("order_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('order_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");
    ...
    public List<ForeignKey<OrderRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<OrderRecord, ?>>asList(Keys.ORDER__ORDERS_IBFK_1);
    }

    public Customer customer() {
        return new Customer(this, Keys.ORDER__ORDERS_IBFK_1);
    }
