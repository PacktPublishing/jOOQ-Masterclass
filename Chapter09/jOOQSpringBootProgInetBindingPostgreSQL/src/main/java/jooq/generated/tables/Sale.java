...
public class Sale extends TableImpl<SaleRecord> {
    ...
    private static final long serialVersionUID = -1789707937;
     ...
     */
    public final TableField<SaleRecord, Boolean> HOT = createField(DSL.name("hot"), org.jooq.impl.SQLDataType.BOOLEAN.defaultValue(org.jooq.impl.DSL.field("false", org.jooq.impl.SQLDataType.BOOLEAN)), this, "");

    /**
     * The column <code>public.sale.rate</code>.
     */
    public final TableField<SaleRecord, RateType> RATE = createField(DSL.name("rate"), org.jooq.impl.SQLDataType.VARCHAR.asEnumDataType(jooq.generated.enums.RateType.class), this, "");

    /**
     * The column <code>public.sale.vat</code>.
     */
    public final TableField<SaleRecord, VatType> VAT = createField(DSL.name("vat"), org.jooq.impl.SQLDataType.VARCHAR.asEnumDataType(jooq.generated.enums.VatType.class), this, "");

    /**
     * The column <code>public.sale.trend</code>.
     */
    public final TableField<SaleRecord, String> TREND = createField(DSL.name("trend"), org.jooq.impl.SQLDataType.VARCHAR(10).defaultValue(org.jooq.impl.DSL.field("NULL::character varying", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
