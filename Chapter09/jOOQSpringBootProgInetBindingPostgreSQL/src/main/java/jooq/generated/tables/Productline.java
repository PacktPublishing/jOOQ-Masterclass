...
public class Productline extends TableImpl<ProductlineRecord> {
    ...
    private static final long serialVersionUID = 469785989;
     ...
     */
    public final TableField<ProductlineRecord, String> TEXT_DESCRIPTION = createField(DSL.name("text_description"), org.jooq.impl.SQLDataType.VARCHAR(4000).defaultValue(org.jooq.impl.DSL.field("NULL::character varying", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
     ...
     */
    public final TableField<ProductlineRecord, LocalDate> CREATED_ON = createField(DSL.name("created_on"), org.jooq.impl.SQLDataType.LOCALDATE.nullable(false).defaultValue(org.jooq.impl.DSL.field("now()", org.jooq.impl.SQLDataType.LOCALDATE)), this, "");
    ...
    public UniqueKey<ProductlineRecord> getPrimaryKey() {
        return Keys.PRODUCTLINE_PKEY;
    }

    @Override
    public List<UniqueKey<ProductlineRecord>> getKeys() {
        return Arrays.<UniqueKey<ProductlineRecord>>asList(Keys.PRODUCTLINE_PKEY, Keys.UNIQUE_PRODUCT_LINE);
    }
