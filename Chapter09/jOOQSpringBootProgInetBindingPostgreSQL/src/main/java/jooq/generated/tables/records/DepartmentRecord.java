...
public class DepartmentRecord extends UpdatableRecordImpl<DepartmentRecord> implements Record7<Integer, String, String, Short, String, String[], InetAddress> {

    private static final long serialVersionUID = 632031513;
    ...
    /**
     * Setter for <code>public.department.dep_net_ipv4</code>.
     */
    public void setDepNetIpv4(InetAddress value) {
        set(6, value);
    }

    /**
     * Getter for <code>public.department.dep_net_ipv4</code>.
     */
    public InetAddress getDepNetIpv4() {
        return (InetAddress) get(6);
    }
    ...
    @Override
    public Row7<Integer, String, String, Short, String, String[], InetAddress> valuesRow() {
    ...
    @Override
    public Field<InetAddress> field7() {
    ...
    @Override
    public DepartmentRecord value7(InetAddress value) {
        setDepNetIpv4(value);
        return this;
    }

    @Override
    public DepartmentRecord values(Integer value1, String value2, String value3, Short value4, String value5, String[] value6, InetAddress value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DepartmentRecord(Integer departmentId, String name, String phone, Short code, String officeCode, String[] topic, InetAddress depNetIpv4) {
        super(Department.DEPARTMENT);
