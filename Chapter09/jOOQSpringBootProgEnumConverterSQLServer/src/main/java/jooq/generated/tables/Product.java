...
public class Product extends TableImpl<ProductRecord> {
    ...
    /**
     * The reference instance of <code>classicmodels.dbo.product</code>
     */
    ...
    /**
     * The column <code>classicmodels.dbo.product.product_id</code>.
     */
    ...
    /**
     * The column <code>classicmodels.dbo.product.product_name</code>.
     */
    ...
    /**
     * The column <code>classicmodels.dbo.product.product_line</code>.
     */
    ...
    /**
     * The column <code>classicmodels.dbo.product.product_scale</code>.
     */
    ...
    /**
     * The column <code>classicmodels.dbo.product.product_vendor</code>.
     */
    ...
    /**
     * The column <code>classicmodels.dbo.product.product_description</code>.
     */
    public final TableField<ProductRecord, String> PRODUCT_DESCRIPTION = createField(DSL.name("product_description"), SQLDataType.VARCHAR.defaultValue(DSL.field("(NULL)", SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>classicmodels.dbo.product.quantity_in_stock</code>.
     */
    ...
    /**
     * The column <code>classicmodels.dbo.product.buy_price</code>.
     */
    ...
    /**
     * The column <code>classicmodels.dbo.product.specs</code>.
     */
    public final TableField<ProductRecord, String> SPECS = createField(DSL.name("specs"), SQLDataType.VARCHAR.defaultValue(DSL.field("(NULL)", SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>classicmodels.dbo.product.msrp</code>.
     */
    ...
    /**
     * Create an aliased <code>classicmodels.dbo.product</code> table reference
     */
    ...
    /**
     * Create a <code>classicmodels.dbo.product</code> table reference
     */
    public Product() {
    ...
    public UniqueKey<ProductRecord> getPrimaryKey() {
        return Keys.PRODUCT__PK__PRODUCT__47027DF5FF2ABAC4;
    }

    @Override
    public List<UniqueKey<ProductRecord>> getKeys() {
        return Arrays.<UniqueKey<ProductRecord>>asList(Keys.PRODUCT__PK__PRODUCT__47027DF5FF2ABAC4);
    }
