...
public class Orderdetail extends TableImpl<OrderdetailRecord> {
    ...
    /**
     * The reference instance of <code>classicmodels.dbo.orderdetail</code>
     */
    ...
    /**
     * The column <code>classicmodels.dbo.orderdetail.order_id</code>.
     */
    ...
    /**
     * The column <code>classicmodels.dbo.orderdetail.product_id</code>.
     */
    ...
    /**
     * The column <code>classicmodels.dbo.orderdetail.quantity_ordered</code>.
     */
    ...
    /**
     * The column <code>classicmodels.dbo.orderdetail.price_each</code>.
     */
    public final TableField<OrderdetailRecord, BigDecimal> PRICE_EACH = createField(DSL.name("price_each"), SQLDataType.NUMERIC(10, 2).nullable(false), this, "");

    /**
     * The column <code>classicmodels.dbo.orderdetail.order_line_number</code>.
     */
    ...
    /**
     * Create an aliased <code>classicmodels.dbo.orderdetail</code> table reference
     */
    ...
    /**
     * Create a <code>classicmodels.dbo.orderdetail</code> table reference
     */
    public Orderdetail() {
    ...
    public UniqueKey<OrderdetailRecord> getPrimaryKey() {
        return Keys.ORDERDETAIL__PK__ORDERDET__022945F6F2F39519;
    }

    @Override
    public List<UniqueKey<OrderdetailRecord>> getKeys() {
        return Arrays.<UniqueKey<OrderdetailRecord>>asList(Keys.ORDERDETAIL__PK__ORDERDET__022945F6F2F39519);
    }
