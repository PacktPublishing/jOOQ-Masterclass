...
public class SaleRateIntConverter implements Converter<RateType, Integer> {

    public final static SaleRateIntConverter SALE_RATE_INT_CONVERTER = new SaleRateIntConverter();
