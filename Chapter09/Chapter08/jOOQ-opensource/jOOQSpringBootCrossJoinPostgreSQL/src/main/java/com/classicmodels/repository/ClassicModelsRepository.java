...
public class ClassicModelsRepository {
    ...
    from 
      ...
      left outer join (
        ...
        from 
          "public"."order" as "o" 
          join "public"."orderdetail" as "i" on "i"."order_id" = "o"."order_id" 
          join "public"."customer" as "c" on "c"."customer_number" = "o"."customer_number" 
          join "public"."product" as "p" on "p"."product_id" = "i"."product_id" 
        group by 
          "c"."customer_number", 
          "p"."product_id"
      ) as "alias_6074921" on (
