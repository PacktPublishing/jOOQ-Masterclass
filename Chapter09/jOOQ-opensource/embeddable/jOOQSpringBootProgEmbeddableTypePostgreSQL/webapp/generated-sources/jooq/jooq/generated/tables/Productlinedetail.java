...
public class Productlinedetail extends TableImpl<ProductlinedetailRecord> {
    ...
    public UniqueKey<ProductlinedetailRecord> getPrimaryKey() {
        return Keys.PRODUCTLINEDETAIL_PK;
    }

    @Override
    public List<UniqueKey<ProductlinedetailRecord>> getKeys() {
        return Arrays.<UniqueKey<ProductlinedetailRecord>>asList(Keys.PRODUCTLINEDETAIL_PK, Keys.PRODUCTLINEDETAIL_UK);
    }

    @Override
    public List<ForeignKey<ProductlinedetailRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<ProductlinedetailRecord, ?>>asList(Keys.PRODUCTLINEDETAIL__PRODUCTLINEDETAIL_FK);
    }

    public Productline productline() {
        return new Productline(this, Keys.PRODUCTLINEDETAIL__PRODUCTLINEDETAIL_FK);
    }
