...
public class Top3product extends TableImpl<Top3productRecord> {
     ...
     */
    public final TableField<Top3productRecord, String> PRODUCT_NAME = createField(DSL.name("product_name"), SQLDataType.VARCHAR(70).defaultValue(DSL.field("NULL::character varying", SQLDataType.VARCHAR)), this, "");
    ...
    public UniqueKey<Top3productRecord> getPrimaryKey() {
        return Keys.TOP3PRODUCT_PK;
    }

    @Override
    public List<UniqueKey<Top3productRecord>> getKeys() {
        return Arrays.<UniqueKey<Top3productRecord>>asList(Keys.TOP3PRODUCT_PK);
    }

    @Override
    public List<ForeignKey<Top3productRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<Top3productRecord, ?>>asList(Keys.TOP3PRODUCT__TOP3PRODUCT_PRODUCT_FK);
    }

    public Product product() {
        return new Product(this, Keys.TOP3PRODUCT__TOP3PRODUCT_PRODUCT_FK);
    }
