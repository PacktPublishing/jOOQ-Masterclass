...
public class OfficeHasManager extends TableImpl<OfficeHasManagerRecord> {
    ...
    public List<UniqueKey<OfficeHasManagerRecord>> getKeys() {
        return Arrays.<UniqueKey<OfficeHasManagerRecord>>asList(Keys.OFFICE_MANAGER_UK);
    }

    @Override
    public List<ForeignKey<OfficeHasManagerRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<OfficeHasManagerRecord, ?>>asList(Keys.OFFICE_HAS_MANAGER__OFFICE_FK, Keys.OFFICE_HAS_MANAGER__MANAGER_FK);
    }

    public Office office() {
        return new Office(this, Keys.OFFICE_HAS_MANAGER__OFFICE_FK);
    }

    public Manager manager() {
        return new Manager(this, Keys.OFFICE_HAS_MANAGER__MANAGER_FK);
    }
