...
public class Order extends TableImpl<OrderRecord> {
     ...
     */
    public final TableField<OrderRecord, BigDecimal> AMOUNT = createField(DSL.name("amount"), SQLDataType.NUMERIC(10, 2).nullable(false), this, "");
    ...
    public List<ForeignKey<OrderRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<OrderRecord, ?>>asList(Keys.ORDER__ORDER_CUSTOMER_FK);
    }

    public Customer customer() {
        return new Customer(this, Keys.ORDER__ORDER_CUSTOMER_FK);
    }
