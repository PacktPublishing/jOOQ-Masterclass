...
public class Product extends TableImpl<ProductRecord> {
     ...
     */
    public final TableField<ProductRecord, Long> PRODUCT_ID = createField(DSL.name("product_id"), SQLDataType.BIGINT.nullable(false).defaultValue(DSL.field("nextval('product_seq'::regclass)", SQLDataType.BIGINT)), this, "");
     ...
     */
    public final TableField<ProductRecord, BigDecimal> BUY_PRICE = createField(DSL.name("buy_price"), SQLDataType.NUMERIC(10, 2).nullable(false).defaultValue(DSL.field("0.0", SQLDataType.NUMERIC)), this, "");

    /**
     * The column <code>public.product.msrp</code>.
     */
    public final TableField<ProductRecord, BigDecimal> MSRP = createField(DSL.name("msrp"), SQLDataType.NUMERIC(10, 2).nullable(false).defaultValue(DSL.field("0.0", SQLDataType.NUMERIC)), this, "");
     ...
     */
    public final TableField<ProductRecord, Long> PRODUCT_UID = createField(DSL.name("product_uid"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");
    ...
    public List<ForeignKey<ProductRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<ProductRecord, ?>>asList(Keys.PRODUCT__PRODUCT_PRODUCTLINE_FK);
    }

    public Productline productline() {
        return new Productline(this, Keys.PRODUCT__PRODUCT_PRODUCTLINE_FK);
    }
