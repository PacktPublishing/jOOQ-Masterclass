...
public class Customerdetail extends TableImpl<CustomerdetailRecord> {
     ...
     */
    public final TableField<CustomerdetailRecord, String> ADDRESS_LINE_SECOND = createField(DSL.name("address_line_second"), SQLDataType.VARCHAR(50).defaultValue(DSL.field("NULL::character varying", SQLDataType.VARCHAR)), this, "");
     ...
     */
    public final TableField<CustomerdetailRecord, String> STATE = createField(DSL.name("state"), SQLDataType.VARCHAR(50).defaultValue(DSL.field("NULL::character varying", SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>public.customerdetail.postal_code</code>.
     */
    public final TableField<CustomerdetailRecord, String> POSTAL_CODE = createField(DSL.name("postal_code"), SQLDataType.VARCHAR(15).defaultValue(DSL.field("NULL::character varying", SQLDataType.VARCHAR)), this, "");
    ...
    public UniqueKey<CustomerdetailRecord> getPrimaryKey() {
        return Keys.CUSTOMERDETAIL_PK;
    }

    @Override
    public List<UniqueKey<CustomerdetailRecord>> getKeys() {
        return Arrays.<UniqueKey<CustomerdetailRecord>>asList(Keys.CUSTOMERDETAIL_PK, Keys.CUSTOMER_ADDRESS_LINE_FIRST_UK);
    }

    @Override
    public List<ForeignKey<CustomerdetailRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<CustomerdetailRecord, ?>>asList(Keys.CUSTOMERDETAIL__CUSTOMERDETAIL_CUSTOMER_FK);
    }

    public Customer customer() {
        return new Customer(this, Keys.CUSTOMERDETAIL__CUSTOMERDETAIL_CUSTOMER_FK);
    }
