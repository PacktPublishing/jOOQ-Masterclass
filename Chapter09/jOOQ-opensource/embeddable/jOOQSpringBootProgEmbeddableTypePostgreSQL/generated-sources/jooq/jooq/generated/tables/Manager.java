...
public class Manager extends TableImpl<ManagerRecord> {
    ...
    /**
     * The column <code>public.manager.manager_detail</code>.
     */
    public final TableField<ManagerRecord, JSON> MANAGER_DETAIL = createField(DSL.name("manager_detail"), SQLDataType.JSON, this, "");

    /**
     * The column <code>public.manager.manager_evaluation</code>.
     */
    public final TableField<ManagerRecord, EvaluationCriteriaRecord> MANAGER_EVALUATION = createField(DSL.name("manager_evaluation"), jooq.generated.udt.EvaluationCriteria.EVALUATION_CRITERIA.getDataType(), this, "");
    ...
    public List<UniqueKey<ManagerRecord>> getKeys() {
        return Arrays.<UniqueKey<ManagerRecord>>asList(Keys.MANAGER_PK);
    }
