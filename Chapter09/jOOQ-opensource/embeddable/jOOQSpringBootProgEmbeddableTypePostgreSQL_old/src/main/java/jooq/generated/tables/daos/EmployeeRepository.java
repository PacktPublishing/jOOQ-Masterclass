...
public class EmployeeRepository extends DAOImpl<EmployeeRecord, JooqEmployee, Long> {
     ...
     */
    public List<JooqEmployee> fetchRangeOfEmployeeOfYear(Integer[] lowerInclusive, Integer[] upperInclusive) {
     ...
     */
    public List<JooqEmployee> fetchByEmployeeOfYear(Integer[]... values) {
