...
public class Keys {
    ...
    public static final UniqueKey<BankTransactionRecord> BANK_TRANSACTION_PKEY = Internal.createUniqueKey(BankTransaction.BANK_TRANSACTION, DSL.name("bank_transaction_pkey"), new TableField[] { BankTransaction.BANK_TRANSACTION.TRANSACTION_ID }, true);
    ...
    public static final UniqueKey<Top3productRecord> TOP3PRODUCT_PKEY = Internal.createUniqueKey(Top3product.TOP3PRODUCT, DSL.name("top3product_pkey"), new TableField[] { Top3product.TOP3PRODUCT.PRODUCT_ID }, true);

    // -------------------------------------------------------------------------
    // FOREIGN KEY definitions
    // -------------------------------------------------------------------------

    public static final ForeignKey<BankTransactionRecord, PaymentRecord> BANK_TRANSACTION__BANK_TRANSACTION_IBFK_1 = Internal.createForeignKey(BankTransaction.BANK_TRANSACTION, DSL.name("bank_transaction_ibfk_1"), new TableField[] { BankTransaction.BANK_TRANSACTION.CUSTOMER_NUMBER, BankTransaction.BANK_TRANSACTION.CHECK_NUMBER }, Keys.PAYMENT_PKEY, new TableField[] { Payment.PAYMENT.CUSTOMER_NUMBER, Payment.PAYMENT.CHECK_NUMBER }, true);
    ...
    public static final ForeignKey<Top3productRecord, ProductRecord> TOP3PRODUCT__TOP3PRODUCT_IBFK_1 = Internal.createForeignKey(Top3product.TOP3PRODUCT, DSL.name("top3product_ibfk_1"), new TableField[] { Top3product.TOP3PRODUCT.PRODUCT_ID }, Keys.PRODUCT_PKEY, new TableField[] { Product.PRODUCT.PRODUCT_ID }, true);
}
