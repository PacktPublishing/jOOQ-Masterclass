        ...
        Configuration configuration = new Configuration()
                ...
                .withGenerator(new Generator()
                        .withDatabase(new Database()
                                .withForcedTypes(
                                        new ForcedType()
                                                .withUserType(jooqProperties.getWithUserType())
                                                .withLambdaConverter(new LambdaConverter()
                                                        .withFrom(jooqProperties.getWithFrom())
                                                        .withTo(jooqProperties.getWithTo()))
                                                .withIncludeExpression(jooqProperties.getWithIncludeExpression())
                                                .withExcludeTypes(jooqProperties.getWithIncludeTypes()))
