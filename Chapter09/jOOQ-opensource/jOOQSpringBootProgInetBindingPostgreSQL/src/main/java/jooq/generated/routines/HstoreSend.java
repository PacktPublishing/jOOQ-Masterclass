...
public class HstoreSend extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = 1040543241;

    /**
     * The parameter <code>public.hstore_send.RETURN_VALUE</code>.
     */
     ...
     */
    public HstoreSend() {
        super("hstore_send", Public.PUBLIC, org.jooq.impl.SQLDataType.BLOB);
