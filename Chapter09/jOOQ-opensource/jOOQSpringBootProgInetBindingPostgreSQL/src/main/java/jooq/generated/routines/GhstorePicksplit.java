...
public class GhstorePicksplit extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1211993948;
     ...
     */
    public GhstorePicksplit() {
        super("ghstore_picksplit", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
