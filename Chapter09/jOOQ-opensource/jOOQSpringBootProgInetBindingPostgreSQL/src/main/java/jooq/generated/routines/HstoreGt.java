...
public class HstoreGt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1992011747;

    /**
     * The parameter <code>public.hstore_gt.RETURN_VALUE</code>.
     */
     ...
     */
    public HstoreGt() {
        super("hstore_gt", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
