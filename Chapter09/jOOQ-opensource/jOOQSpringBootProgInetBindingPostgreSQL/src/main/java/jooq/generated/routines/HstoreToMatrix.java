...
public class HstoreToMatrix extends AbstractRoutine<String[]> {

    private static final long serialVersionUID = -227199199;

    /**
     * The parameter <code>public.hstore_to_matrix.RETURN_VALUE</code>.
     */
     ...
     */
    public HstoreToMatrix() {
        super("hstore_to_matrix", Public.PUBLIC, org.jooq.impl.SQLDataType.CLOB.getArrayDataType());
