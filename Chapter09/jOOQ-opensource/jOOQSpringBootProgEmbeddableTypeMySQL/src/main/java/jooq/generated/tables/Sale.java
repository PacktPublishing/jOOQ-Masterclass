...
public class Sale extends TableImpl<SaleRecord> {
     ...
     */
    public final TableField<SaleRecord, SaleRate> RATE = createField(DSL.name("rate"), SQLDataType.VARCHAR(8).asEnumDataType(jooq.generated.enums.SaleRate.class), this, "");

    /**
     * The column <code>classicmodels.sale.vat</code>.
     */
    public final TableField<SaleRecord, SaleVat> VAT = createField(DSL.name("vat"), SQLDataType.VARCHAR(4).asEnumDataType(jooq.generated.enums.SaleVat.class), this, "");

    /**
     * The column <code>classicmodels.sale.trend</code>.
     */
    public final TableField<SaleRecord, String> TREND = createField(DSL.name("trend"), SQLDataType.VARCHAR(10), this, "");
