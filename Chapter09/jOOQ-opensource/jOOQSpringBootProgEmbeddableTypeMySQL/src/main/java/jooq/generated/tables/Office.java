...
public class Office extends TableImpl<OfficeRecord> {
     ...
     */
    public final TableField<OfficeRecord, LocationRecord> LOCATION = Internal.createEmbeddable(DSL.name("LOCATION"), LocationRecord.class, false, this, CITY, ADDRESS_LINE_FIRST, STATE, COUNTRY);
