...
public class Orderdetail extends TableImpl<OrderdetailRecord> {
    ...
    public UniqueKey<OrderdetailRecord> getPrimaryKey() {
        return Keys.ORDERDETAIL_PKEY;
    }

    @Override
    public List<UniqueKey<OrderdetailRecord>> getKeys() {
        return Arrays.<UniqueKey<OrderdetailRecord>>asList(Keys.ORDERDETAIL_PKEY);
    }

    @Override
    public List<ForeignKey<OrderdetailRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<OrderdetailRecord, ?>>asList(Keys.ORDERDETAIL__ORDERDETAILS_IBFK_1, Keys.ORDERDETAIL__ORDERDETAILS_IBFK_2);
    }

    public Order order() {
        return new Order(this, Keys.ORDERDETAIL__ORDERDETAILS_IBFK_1);
    }

    public Product product() {
        return new Product(this, Keys.ORDERDETAIL__ORDERDETAILS_IBFK_2);
    }
