...
public class CustomerRepository extends DAOImpl<CustomerRecord, JooqCustomer, Long> {
     ...
     */
    public List<JooqCustomer> fetchRangeOfFirstBuyDate(YearMonth lowerInclusive, YearMonth upperInclusive) {
     ...
     */
    public List<JooqCustomer> fetchByFirstBuyDate(YearMonth... values) {
