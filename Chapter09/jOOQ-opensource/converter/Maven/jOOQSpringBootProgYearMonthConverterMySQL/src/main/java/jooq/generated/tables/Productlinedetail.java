...
public class Productlinedetail extends TableImpl<ProductlinedetailRecord> {
     ...
     */
    public final TableField<ProductlinedetailRecord, Integer> LINE_TYPE = createField(DSL.name("line_type"), SQLDataType.INTEGER.defaultValue(DSL.inline("0", SQLDataType.INTEGER)), this, "");
