...
public class Product extends TableImpl<ProductRecord> {
    ...
    private static final long serialVersionUID = 1223854725;
     ...
     */
    public final TableField<ProductRecord, String> PRODUCT_NAME = createField(DSL.name("product_name"), org.jooq.impl.SQLDataType.VARCHAR(70), this, "");

    /**
     * The column <code>classicmodels.product.product_line</code>.
     */
    public final TableField<ProductRecord, String> PRODUCT_LINE = createField(DSL.name("product_line"), org.jooq.impl.SQLDataType.VARCHAR(50), this, "");

    /**
     * The column <code>classicmodels.product.product_scale</code>.
     */
    public final TableField<ProductRecord, String> PRODUCT_SCALE = createField(DSL.name("product_scale"), org.jooq.impl.SQLDataType.VARCHAR(10), this, "");

    /**
     * The column <code>classicmodels.product.product_vendor</code>.
     */
    public final TableField<ProductRecord, String> PRODUCT_VENDOR = createField(DSL.name("product_vendor"), org.jooq.impl.SQLDataType.VARCHAR(50), this, "");
     ...
     */
    public final TableField<ProductRecord, Short> QUANTITY_IN_STOCK = createField(DSL.name("quantity_in_stock"), org.jooq.impl.SQLDataType.SMALLINT.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.SMALLINT)), this, "");

    /**
     * The column <code>classicmodels.product.buy_price</code>.
     */
    public final TableField<ProductRecord, BigDecimal> BUY_PRICE = createField(DSL.name("buy_price"), org.jooq.impl.SQLDataType.DECIMAL(10, 2).defaultValue(org.jooq.impl.DSL.inline("0.00", org.jooq.impl.SQLDataType.DECIMAL)), this, "");

    /**
     * The column <code>classicmodels.product.msrp</code>.
     */
    public final TableField<ProductRecord, BigDecimal> MSRP = createField(DSL.name("msrp"), org.jooq.impl.SQLDataType.DECIMAL(10, 2).defaultValue(org.jooq.impl.DSL.inline("0.00", org.jooq.impl.SQLDataType.DECIMAL)), this, "");

    /**
     * The column <code>classicmodels.product.specs</code>.
     */
    public final TableField<ProductRecord, String> SPECS = createField(DSL.name("specs"), org.jooq.impl.SQLDataType.CLOB, this, "");
