...
public class HstoreToJsonb extends AbstractRoutine<JSONB> {

    private static final long serialVersionUID = 2052849112;

    /**
     * The parameter <code>public.hstore_to_jsonb.RETURN_VALUE</code>.
     */
     ...
     */
    public HstoreToJsonb() {
        super("hstore_to_jsonb", Public.PUBLIC, org.jooq.impl.SQLDataType.JSONB);
