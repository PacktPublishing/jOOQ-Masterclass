...
public class HstoreNe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1374872463;

    /**
     * The parameter <code>public.hstore_ne.RETURN_VALUE</code>.
     */
     ...
     */
    public HstoreNe() {
        super("hstore_ne", Public.PUBLIC, org.jooq.impl.SQLDataType.BOOLEAN);
