...
public class GhstoreDecompress extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1798756260;
     ...
     */
    public GhstoreDecompress() {
        super("ghstore_decompress", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
