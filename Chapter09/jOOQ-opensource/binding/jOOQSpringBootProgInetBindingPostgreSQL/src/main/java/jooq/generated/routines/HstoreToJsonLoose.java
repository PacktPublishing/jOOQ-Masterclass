...
public class HstoreToJsonLoose extends AbstractRoutine<JSON> {

    private static final long serialVersionUID = -821888346;
    ...
    public HstoreToJsonLoose() {
        super("hstore_to_json_loose", Public.PUBLIC, org.jooq.impl.SQLDataType.JSON);
