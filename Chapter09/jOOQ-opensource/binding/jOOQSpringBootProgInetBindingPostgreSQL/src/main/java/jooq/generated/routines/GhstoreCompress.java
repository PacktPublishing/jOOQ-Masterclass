...
public class GhstoreCompress extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 1390257987;
    ...
    public GhstoreCompress() {
        super("ghstore_compress", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
