...
(496, 'Kellys Gift Shop', 'Snowden', 'Tony', '+64 9 5555500', 1612, '110000.00')
end try
begin catch
end catch;
...
(496, 'Arenales 1938 3A', NULL, 'Auckland  ', NULL, NULL, 'New Zealand')
end try
begin catch
end catch;
...
(496, 'MN89921', '2004-12-31', '52166.00', '2004-12-31')
end try
begin catch
end catch;
